...
ar = {
	...
	*/
	...
	menu : {
			...
			btn.on('click', function(e){
				...
				switch(elementClcked){
					case 0:
						...
						break;
					case 1:
						$('#aboutus').scrollTo(ar.options.sectionChangeSpeed, "easeOutQuart");
						break;
					case 2:
					...
					case 4:
						...
						break;
					case 5:
						$('#albania').scrollTo(ar.options.sectionChangeSpeed, "easeOutQuart");
						break;
					case 6:
		...
		setBg : function(bg){
			var backgrounds = new Array('#08233E', '#08233E', '#F8823C', '#2C5379', '#EB2142', '#EB2142', '#08233E', '#F8823C', '#EB2142', '#2C5379'),
				header = $('header');
